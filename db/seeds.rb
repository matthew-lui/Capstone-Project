...
r3= Restaurant.create(business_name: "Avant Garden", address:"130 E 7th Street", phone_number: "917-336-7179", website:"https://www.overthrowhospitality.com/venues/avantgarden", image_url: "https://image.resy.com/3/003/2/561/185147e1f6fae563da60ee9272ebc2d3f41fe3f9/jpg/1:1/1600",likes: rand(1...500), google_coordinates:"", user_id: User.all.sample.id, cuisine: "Vegan", price: "$$$")
...
r9= Restaurant.create(business_name:"Cote", address: "16 West 22nd Street", phone_number: "212-401-7986", website:"https://www.cotenyc.com/", image_url:"https://static01.nyt.com/images/2017/11/15/dining/15REST-2/15REST-slide-PS6H-jumbo.jpg", likes: rand(1...500), google_coordinates:"", user_id: User.all.sample.id, cuisine: "Korean", price:"$$$")
...
r11= Restaurant.create(business_name:"Lilia", address: "567 Union Avenue", phone_number: "718-576-3095", website:"https://www.lilianewyork.com/", image_url:"https://cdn.vox-cdn.com/thumbor/ugtkIL78w2b6biNZ90nupxM_L3s=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/20080749/20200711_GH_LILIA_1003.jpg", likes: rand(1...500), google_coordinates:"", user_id: User.all.sample.id, cuisine: "Italian", price:"$$$")
...
r14= Restaurant.create(business_name:"Nyonya", address: "199 Grand Street", phone_number: "212-344-3669", website: "https://www.yelp.com/biz/nyonya-new-york", image_url:"https://infatuation.imgix.net/media/reviews/nyonya/banners/Nyonya_0.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Malaysian", price: "$")
r15= Restaurant.create(business_name:"Brick Lane", address: "79 2nd Avenue", phone_number: "212-979-2900", website: "https://www.bricklanecurryhouse.com/", image_url:"https://images.squarespace-cdn.com/content/v1/53cc1616e4b0f4361f8ace24/1633188350348-T4OYNDD9FF3385UBB06C/Brick+Lane+JC-front-1.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Indian", price: "$$")
r16= Restaurant.create(business_name:"Electric Burrito", address: "81 St Marks Place", phone_number: "646-870-0104", website: "https://www.electricburritonyc.com/", image_url:"https://cititour.com/NYC_News/photos/Electric_Burrito,_East_Village,_NYC_1.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Mexican", price: "$")
r17= Restaurant.create(business_name:"21 Greenpoint", address: "21 Greenpoint Avenue", phone_number: "718-383-8833", website: "https://www.21greenpoint.com/", image_url:"https://infatuation.imgix.net/media/images/reviews/21-greenpoint/NoahDevereaux_21Greenpoint_Interior_37.JPG",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "New American", price: "$$")
r18= Restaurant.create(business_name:"Hometown Barbeque", address: "454 Van Brunt Street", phone_number: "347-294-4644", website: "https://hometownbbq.com/", image_url:"https://pyxis.nymag.com/v1/imgs/929/dc5/91970a0f6267ec45596e6b7285650aaebb-hometown-bbq-02.rsocial.w1200.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "BBQ", price: "$$")
r19= Restaurant.create(business_name:"Gallagher SteakHouse", address: "228 West 52nd Street", phone_number: "212-586-5000", website: "https://www.gallaghersnysteakhouse.com/", image_url:"https://pyxis.nymag.com/v1/imgs/337/21f/1930740fae60ea0ae84ba505a5232f4db5-gallaghers-steak-house-01.rsocial.w1200.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Steakhouse", price: "$$$")
r20= Restaurant.create(business_name:"Bill's Bar & Burger", address: "16 West 51 Street", phone_number: "212-705-8510", website: "https://www.billsbarandburger.com/", image_url:"https://images.getbento.com/accounts/fb707fea4db9f8bd2a3c03af160d32b5/media/images/34543IMG_0174.jpg?w=1200&fit=crop&auto=compress,format&h=600",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "American", price: "$$")
r21= Restaurant.create(business_name:"Sidney's Five", address: "103 1st Avenue", phone_number: "917-409-3368", website: "https://www.sidneysfive.com/menu", image_url:"https://media.timeout.com/images/105813987/750/422/image.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Breakfast-Brunch", price: "$$")
r22= Restaurant.create(business_name:"Katz Delicatessen", address: "205 E Houston Street", phone_number: "212-254-2246", website: "https://katzsdelicatessen.com/", image_url:"https://d2zyb4ugwufqpc.cloudfront.net/media/wysiwyg/web_2_1.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Kosher-Style", price: "$")
r23= Restaurant.create(business_name:"Wo Hop", address: "17 Mott Street", phone_number: "212-962-8617", website: "https://www.wohop17.com/", image_url:"https://cms.prod.nypr.digital/images/309556/fill-1200x650/",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Chinese", price: "$")
r24= Restaurant.create(business_name:"Fogo De Chao", address: "40 W 53rd Street", phone_number: "212-969-9980", website: "https://fogodechao.com/", image_url:"https://media.timeout.com/images/103410526/image.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Brazillian Steakhouse", price: "$$$")
r25= Restaurant.create(business_name:"Le Botaniste", address: "833 Lexington Avenue", phone_number: "917-262-0766", website: "https://lebotaniste.us/", image_url:"https://fraiche.io/wp-content/uploads/2021/07/Frai%CC%82che-Welcome-Le-Botaniste-NYC-Vegan-restaurant.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Vegan", price: "$$$")
r26= Restaurant.create(business_name:"Casa Enrique", address: "5-48 49th Avenue", phone_number: "347-448-6050", website: "https://casaenriquelic.com/", image_url:"https://pyxis.nymag.com/v1/imgs/e62/4e1/184e6c4aecf34de85b66382f94936f30d8-casa-enrique-01.rsocial.w1200.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "New-Mexican", price: "$$")
r27= Restaurant.create(business_name:"All Antico", address: "225 Sullivan Street", phone_number: "212-969-9980", website: "https://www.allanticovinaionyc.com/", image_url:"https://media-cdn.tripadvisor.com/media/photo-s/27/ae/9a/b1/interior.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Italian", price: "$")
r28= Restaurant.create(business_name:"Pierozek", address: "592 Manhattan Avenue", phone_number: "718-576-3866", website: "https://www.pierozekbrooklyn.com/", image_url:"https://static01.nyt.com/images/2020/01/09/dining/09HUNGRY-slide-64LH/09HUNGRY-slide-64LH-mobileMasterAt3x.jpg",likes: rand(1...500), google_coordinates:"",user_id: User.all.sample.id, cuisine: "Polish", price: "$$")
